...
var NzResizeHandleComponent = class _NzResizeHandleComponent {
  ...
  static {
    this.ɵfac = function NzResizeHandleComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NzResizeHandleComponent)(ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(NzResizableService), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NzDestroyService));
    };
  }
  static {
