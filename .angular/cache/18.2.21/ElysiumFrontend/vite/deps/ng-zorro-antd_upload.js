...
import {
  NzButtonComponent,
  NzButtonModule
} from "./chunk-WA2UB2PD.js";
import "./chunk-E37JKKFX.js";
import {
  NzTransitionPatchDirective
} from "./chunk-VDILG7EH.js";
...
function NzUploadListComponent_For_1_ng_template_4_Conditional_0_Case_0_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, NzUploadListComponent_For_1_ng_template_4_Conditional_0_Case_0_Conditional_0_Template, 1, 0, "span", 21)(1, NzUploadListComponent_For_1_ng_template_4_Conditional_0_Case_0_Conditional_1_Template, 1, 1, "span", 22);
  }
  if (rf & 2) {
...
function NzUploadListComponent_For_1_ng_template_4_Conditional_0_Case_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, NzUploadListComponent_For_1_ng_template_4_Conditional_0_Case_1_Conditional_0_Template, 1, 1)(1, NzUploadListComponent_For_1_ng_template_4_Conditional_0_Case_1_Conditional_1_Template, 1, 1, "span", 22);
  }
  if (rf & 2) {
    const file_r5 = ɵɵnextContext(2).$implicit;
    ɵɵconditional(file_r5.isUploading ? 0 : 1);
...
function NzUploadListComponent_For_1_ng_template_4_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, NzUploadListComponent_For_1_ng_template_4_Conditional_0_Case_0_Template, 2, 1)(1, NzUploadListComponent_For_1_ng_template_4_Conditional_0_Case_1_Template, 2, 1)(2, NzUploadListComponent_For_1_ng_template_4_Conditional_0_Case_2_Template, 1, 1, "span", 20);
  }
  if (rf & 2) {
    let tmp_19_0;
...
function NzUploadListComponent_For_1_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, NzUploadListComponent_For_1_Conditional_18_Conditional_1_Template, 2, 4, "a", 31)(2, NzUploadListComponent_For_1_Conditional_18_Conditional_2_Template, 1, 1, null, 10)(3, NzUploadListComponent_For_1_Conditional_18_ng_template_3_Template, 0, 0, "ng-template", 10);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const file_r1 = ɵɵnextContext().$implicit;
...
var NzUploadBtnComponent = class _NzUploadBtnComponent {
  ...
  static {
    this.ɵfac = function NzUploadBtnComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NzUploadBtnComponent)(ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(ElementRef));
    };
  }
  static {
...
var NzUploadListComponent = class _NzUploadListComponent {
  ...
  static {
    this.ɵfac = function NzUploadListComponent_Factory(__ngFactoryType__) {
...
var NzUploadComponent = class _NzUploadComponent {
  ...
  static {
    this.ɵfac = function NzUploadComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NzUploadComponent)(ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(NzI18nService), ɵɵdirectiveInject(Directionality));
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
...
var NzUploadModule = class _NzUploadModule {
  static {
    this.ɵfac = function NzUploadModule_Factory(__ngFactoryType__) {
