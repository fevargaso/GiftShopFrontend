...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () => import('@features/app-reporter/app-reporter.routes').then(mod => mod.appReporterRoutes),
  },
  {
    path: 'products',
    loadChildren: () => import('@features/products/pages/products.routes').then(m => m.PRODUCTS_ROUTES),
  },

  {
    path: 'orders',
    canActivate: [authGuard],
    loadChildren: () => import('@features/orders/pages/orders.routes').then(m => m.ORDERS_ROUTES),
  },

  {
    path: 'cart',
    loadChildren: () => import('@features/cart/pages/cart.routes').then(m => m.CARTS_ROUTES),
  },
  {
    path: 'login',
  ...
  {
    path: 'forbidden',
    loadChildren: () => import('@features/forbidden/forbidden.routes').then(mod => mod.forbiddenRoutes),
  },
