...
export class FeatureFormComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    formData.append('type', `${this.translate.instant('General.APP_NAME')}: ${this.translate.instant('AppReporter.FEATURE_TITLE')}`);
    ...
    this.janusBambooHrService.sendNotification(formData)
      .subscribe({
        error: (err: any) => {
          ...
          console.error(err);
          this.notification.error(this.translate.instant('AppReporter.ERROR_RESPONSE'));
        },
        complete: () => {
